...
ActiveRecord::Schema[7.1].define(version: 20_251_108_001_525) do
  ...
  create_table 'chats', charset: 'utf8mb4', collation: 'utf8mb4_unicode_ci', force: :cascade do |t|
    ...
    t.datetime 'created_at', null: false
    t.datetime 'updated_at', null: false
    t.index %w[application_id number], name: 'index_chats_on_application_id_and_number', unique: true
  ...
  create_table 'messages', charset: 'utf8mb4', collation: 'utf8mb4_unicode_ci', force: :cascade do |t|
    ...
    t.datetime 'created_at', null: false
    t.datetime 'updated_at', null: false
    t.index %w[chat_id number], name: 'index_messages_on_chat_id_and_number', unique: true
